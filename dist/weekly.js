...
class default_1 extends helpers_1.BaseCronComponent {
    ...
    onDaySelection(e) {
        ...
        let currentDaysOfWeek = this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX] === '*' ? [] : this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX].split(',');
        // Cleanup
                    ...
                    react_1.default.createElement(reactstrap_1.Container, null,
                        react_1.default.createElement(reactstrap_1.Row, null,
                            react_1.default.createElement(reactstrap_1.Col, { className: "col-6" },
                                react_1.default.createElement(reactstrap_1.CustomInput, { id: "checkbox-monday", type: "checkbox", value: "MON", label: "Monday", onChange: (e) => this.onDaySelection.bind(this)(e), checked: this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX].includes('MON') }),
                                react_1.default.createElement(reactstrap_1.CustomInput, { id: "checkbox-wednesday", type: "checkbox", value: "WED", label: "Wednesday", onChange: (e) => this.onDaySelection.bind(this)(e), checked: this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX].includes('WED') }),
                                react_1.default.createElement(reactstrap_1.CustomInput, { id: "checkbox-friday", type: "checkbox", value: "FRI", label: "Friday", onChange: (e) => this.onDaySelection.bind(this)(e), checked: this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX].includes('FRI') }),
                                react_1.default.createElement(reactstrap_1.CustomInput, { id: "checkbox-sunday", type: "checkbox", value: "SUN", label: "Sunday", onChange: (e) => this.onDaySelection.bind(this)(e), checked: this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX].includes('SUN') })),
                            react_1.default.createElement(reactstrap_1.Col, { className: "col-6" },
                                react_1.default.createElement("div", { className: "text_align_left" },
                                    react_1.default.createElement(reactstrap_1.CustomInput, { id: "checkbox-tuesday", type: "checkbox", value: "TUE", label: "Tuesday", onChange: (e) => this.onDaySelection.bind(this)(e), checked: this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX].includes('TUE') }),
                                    react_1.default.createElement(reactstrap_1.CustomInput, { id: "checkbox-thursday", type: "checkbox", value: "THU", label: "Thursday", onChange: (e) => this.onDaySelection.bind(this)(e), checked: this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX].includes('THU') }),
                                    react_1.default.createElement(reactstrap_1.CustomInput, { id: "checkbox-saturday", type: "checkbox", value: "SAT", label: "Saturday", onChange: (e) => this.onDaySelection.bind(this)(e), checked: this.state.value[const_1.DAY_OF_WEEK_POSITION_INDEX].includes('SAT') })))))),
                react_1.default.createElement(reactstrap_1.Row, { className: "mt-sm-1" },
                    react_1.default.createElement(reactstrap_1.Col, null,
                        react_1.default.createElement(reactstrap_1.Form, { inline: true },
                            react_1.default.createElement(reactstrap_1.FormGroup, null,
                                ...
                                react_1.default.createElement(tzDropdown_1.TzDropdown, { defaultValue: this.state.timezone, id: "weekly-dropdown", onChange: (tz) => console.log('TZCHANGE', tz) }))))))));
    }
}
